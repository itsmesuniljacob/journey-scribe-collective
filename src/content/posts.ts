...
export const posts: Post[] = [
  ...
  //     {
  //       type: "p",
  //       text: "Singapore is the most forgiving city to travel with kids. It's safe, clean, English-speaking, and small enough that you can change plans on the fly without losing a day to logistics.",
  //     },
  //     { type: "h2", text: "Where we stayed" },
  //     {
  //       type: "p",
  //       text: "We split the trip between two neighbourhoods to cut down on MRT time: two nights near Bugis (close to the Gardens) and two nights in Sentosa (so the kids could collapse straight into the pool after Universal Studios).",
  //     },
  //     {
  //       type: "callout",
  //       tone: "tip",
  //       title: "Insider tip",
  //       text: "Buy a Singapore Tourist Pass on arrival at the airport MRT counter — three days of unlimited transit for less than three single Grab rides.",
  //     },
  //     {
  //       type: "itinerary",
  //       day: 1,
  //       title: "Arrival & Gardens by the Bay",
  //       items: [
  ...
  //       type: "itinerary",
  //       day: 4,
  //       title: "Slow morning + flight",
  //       items: ["Breakfast at Tiong Bahru Bakery", "Singapore Zoo or River Wonders", "Late lunch & airport transfer"],
  //     },
  //     { type: "h2", text: "What we'd skip next time" },
  //     {
  //       type: "proscons",
  //       pros: ["Gardens by the Bay (twice)", "Hawker centres for almost every meal", "Sentosa cable car"],
  //       cons: [
  ...
  //         {
  //           q: "Is 4 days enough?",
  //           a: "Yes — Singapore is best as a 3–5 day stop. Past a week the same neighbourhoods start to repeat themselves.",
  //         },
  //         {
  //           q: "Best month for families?",
  //           a: "February to April: drier, slightly cooler, and outside the school-holiday crowds at Universal.",
  //         },
  //       ],
  //     },
  //   ],
